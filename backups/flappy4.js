...
function player(){
	...
	this.elemento.style = `height:${playerHeight};width:${playerWidth};position:relative;left:${windowWidth/2};top:${birdTop};`
...
function start(){
	...
	setInterval(function(){
		...
		//Colisão Barreiras
		if((barreirasLeft < birdLeft)&&(barreirasLeft>birdLeft - playerWidth - barreirasWidth)){		//Colisão Barreira Superior
			alert("colisao")
		}
