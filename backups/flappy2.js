...
function barreira_superior(supHeight, supLeft){
	...
	this.elemento.style = `width:100;height:${supHeight};position:relative;top:${-playerAltura};left:${supLeft};border:solid;border-width:2px;background-color:lime;`
}

function barreira_inferior(infHeight,infLeft){
	this.elemento = novoElemento('div','barreira_i')
	this.elemento.style = `width:100;height:${infHeight};position:relative;top:${abertura-playerAltura};left:${infLeft};border:solid;border-width:2px;background-color:lime;`
}
...
function player(){
	...
	this.elemento.style = `height:${playerHeight};width:${playerWidth};position:relative;left:500;top:200;`
...
function start(){
	...
	setInterval(function(){
		...
		if(birdTop>bordaAltura-playerAltura){		
			gameover()
		}

		//Colisão barreira Superior
		if((barreiraLeft < birdLeft+playerWidth)&&(barreiraLeft > birdLeft-100)&&(birdTop>-1)&&(birdTop<barreiraSupAltura)){
			gameover()
		}
